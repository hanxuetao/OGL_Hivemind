...
[System.Serializable]
public class CharacterPair_OLD
{
...
public class GhostManager_OLD : MonoBehaviour {
    
    public GameObject background;
    public List<CharacterPair_OLD> characters = new List<CharacterPair_OLD>();
    ...
    void Update () {
        ...
        foreach (CharacterPair_OLD character in characters)
        {
