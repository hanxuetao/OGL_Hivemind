...
public class CharacterEditor : EditorWindow
{
    ...
    void OnEnable()
    {
        ...
        {
            characters = AssetDatabase.LoadAssetAtPath<Characters>("Assets/") as Characters;
        }
    }
        ...
        if (characters)
        {
            ...
            if (characters.allCharacters.Count > 0)
            {
                ...
                if (characters.allCharacters[viewIndex - 1])
                {
                    ...
                    characters.allCharacters[viewIndex - 1].defaultFloor = EditorGUILayout.IntField("Default Floor", characters.allCharacters[viewIndex - 1].defaultFloor);
                    ...
                    //characters.allCharacters[viewIndex - 1].comments =
                    //characters.allCharacters[viewIndex - 1].spritesWalkRight = 
                    //characters.allCharacters[viewIndex - 1].spritesRunRight = 
    ...
    {
        string absPath = EditorUtility.OpenFilePanel("Find character list asset", "", "asset");
        if (absPath.StartsWith(Application.dataPath))
        {
            string relPath = absPath.Substring(Application.dataPath.Length - "Assets".Length);
